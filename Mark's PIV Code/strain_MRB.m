...
% figure('Color',[1 1 1]); imagesc(Zx,[min(min(Zx)),max(max(Zx))]); colormap('jet'); colorbar
% title('u_{x}','FontSize',30); axis off; set(colorbar,'fontsize',25)
% figure('Color',[1 1 1]); imagesc(Zy,[min(min(Zy)),max(max(Zy))]); colormap('jet'); colorbar
% title('u_{y}','FontSize',30);axis off; set(colorbar,'fontsize',25)
% figure('Color',[1 1 1]); imagesc(dxdy, [min(min(dxdy)),max(max(dxdy))]); colormap('jet'); colorbar
% title('\gamma_{yx}','FontSize',30); axis off; set(colorbar,'fontsize',25)
% figure('Color',[1 1 1]); imagesc(dydx, [min(min(dydx)),max(max(dydx))]); colormap('jet'); colorbar
